...
var days_of_week = {0: "Su", 1: "Mo", 2: "Tu", 3: "We", 4: "Th",
                    5: "Fr", 6: "Sa"};
...
// Y is a flag to pass in to tell this to dump output into the class'
// buckets instead of console logging everything,
// which writeYear will use to generate the year's calendar
// (ie, writeMonth is a helper function to writeYear with the flag enabled).
// without the flag it's its own function and prints the specified month.
